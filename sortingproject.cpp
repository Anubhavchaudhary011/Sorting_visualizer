...
void intro()
{
    cout<<"==============================================================================Sorting Visualizer===================================================================================\n\n"
        <<"Welcome to the Sorting Visualizer! This interactive tool is designed to help you explore and "
        <<"understand how various sorting algorithms work. By visualizing the sorting process in\nreal-"
        <<"time, you can gain insights into mechanics and performance of different algorithms. "
        <<"If you're ready to exit the program at any time, simply follow the exit option "
        <<"provided.  Whether you're a student learning about algorithms or a developer seeking to"
        <<" understand sorting methods better, this visualizer provides a clear and engaging way to"
        << " grasp these \nessential concepts. Enjoy the exploration and happy sorting!\n\n"
